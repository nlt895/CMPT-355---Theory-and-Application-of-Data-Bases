...
SELECT universities.name university,departments.name department, courses.name course,course_desc, credit_units
...
/*2)  We want to check to see if the number of students enrolled in the enrollments table matches the number of students in sections.num_enrolled. Write a query to return a count 
...
--implicit join
SELECT courses.code course_code,courses.name course_name,lec_type,max_enrollment,num_enrolled,max_enrollment-num_enrolled remaining_available,first_name,last_name,sections.start_time section_Start, sections.end_time section_End, terms.start_date term_Start, terms.end_date term_End
...
SELECT courses.code course_code,courses.name course_name,lec_type,number_section
...
SELECT courses.code course_code,courses.name course_name,section_code,lec_type,
